...
struct DistanceField
{
	...
	void	GetWorldToTopDownTextureMatrix( D3DXMATRIX& worldToTopDownMatrix );
...
private:
	...
	D3DXVECTOR3 m_topDownViewPositionWS;
	D3DXVECTOR3 m_viewDirectionWS;
	D3DXMATRIX	m_worldToViewMatrix;
	D3DXMATRIX	m_viewToProjectionMatrix;

	bool m_shouldGenerateDataTexture;

	void renderTopDownData(ID3D11DeviceContext* pDC, const D3DXVECTOR3& eyePositionWS );
